...
-- Equation(s):
-- \s_sreg~3_combout\ = (\load~input_o\ & (\dataIn[3]~input_o\)) # (!\load~input_o\ & ((s_sreg(0))))
...
-- Equation(s):
-- \s_sreg~2_combout\ = (\load~input_o\ & (\dataIn[2]~input_o\)) # (!\load~input_o\ & ((s_sreg(3))))
...
-- Equation(s):
-- \s_sreg~1_combout\ = (\load~input_o\ & (\dataIn[1]~input_o\)) # (!\load~input_o\ & ((s_sreg(2))))
...
-- Equation(s):
-- \s_sreg~0_combout\ = (\load~input_o\ & (\dataIn[0]~input_o\)) # (!\load~input_o\ & ((s_sreg(1))))
