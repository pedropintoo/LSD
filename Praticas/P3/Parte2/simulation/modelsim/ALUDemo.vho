...
SIGNAL \ALU4|Mux0~4_combout\ : std_logic;
SIGNAL \ALU4|Mux0~5_combout\ : std_logic;
...
-- Equation(s):
-- \ALU4|Mult0|auto_generated|le4a\(3) = (\ALU4|Mult0|auto_generated|cs2a[1]~0_combout\ & (\SW[7]~input_o\ $ ((\ALU4|Mult0|auto_generated|le4a\(5))))) # (!\ALU4|Mult0|auto_generated|cs2a[1]~0_combout\ & (((\ALU4|Mult0|auto_generated|le4a\(5) & 
-- !\SW[6]~input_o\))))
...
-- Equation(s):
-- \ALU4|Mult0|auto_generated|le4a\(2) = (\ALU4|Mult0|auto_generated|cs2a[1]~0_combout\ & ((\SW[6]~input_o\ $ (\ALU4|Mult0|auto_generated|le4a\(5))))) # (!\ALU4|Mult0|auto_generated|cs2a[1]~0_combout\ & (!\SW[5]~input_o\ & 
...
PORT MAP (
	...
	datab => \SW[5]~input_o\,
	datac => \SW[6]~input_o\,
	datad => \ALU4|Mult0|auto_generated|le4a\(5),
...
-- pragma translate_on
PORT MAP (
	datab => \ALU4|Mult0|auto_generated|le3a\(3),
	datad => VCC,
...
-- Equation(s):
-- \ALU4|Mult0|auto_generated|op_1~8_combout\ = ((\ALU4|Mult0|auto_generated|le4a\(4) $ (\ALU4|Mult0|auto_generated|le5a\(2) $ (!\ALU4|Mult0|auto_generated|op_1~7\)))) # (GND)
-- \ALU4|Mult0|auto_generated|op_1~9\ = CARRY((\ALU4|Mult0|auto_generated|le4a\(4) & ((\ALU4|Mult0|auto_generated|le5a\(2)) # (!\ALU4|Mult0|auto_generated|op_1~7\))) # (!\ALU4|Mult0|auto_generated|le4a\(4) & (\ALU4|Mult0|auto_generated|le5a\(2) & 
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Mult0|auto_generated|le4a\(4),
	datab => \ALU4|Mult0|auto_generated|le5a\(2),
	datad => VCC,
...
-- Equation(s):
-- \ALU4|Mult0|auto_generated|op_1~10_combout\ = \ALU4|Mult0|auto_generated|le5a\(3) $ (\ALU4|Mult0|auto_generated|op_1~9\ $ (!\ALU4|Mult0|auto_generated|le4a\(5)))
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Mult0|auto_generated|le5a\(3),
	datad => \ALU4|Mult0|auto_generated|le4a\(5),
...
-- Equation(s):
-- \ALU4|Mult0|auto_generated|le4a\(1) = (\ALU4|Mult0|auto_generated|cs2a[1]~0_combout\ & (\SW[5]~input_o\ $ (((\ALU4|Mult0|auto_generated|le4a\(5)))))) # (!\ALU4|Mult0|auto_generated|cs2a[1]~0_combout\ & (((!\SW[4]~input_o\ & 
-- \ALU4|Mult0|auto_generated|le4a\(5)))))
...
PORT MAP (
	dataa => \SW[5]~input_o\,
	datab => \ALU4|Mult0|auto_generated|cs2a[1]~0_combout\,
	datac => \SW[4]~input_o\,
	datad => \ALU4|Mult0|auto_generated|le4a\(5),
...
-- Equation(s):
-- \ALU4|Mult0|auto_generated|le4a\(0) = \SW[3]~input_o\ $ (((\SW[1]~input_o\ & ((\SW[4]~input_o\) # (\SW[2]~input_o\))) # (!\SW[1]~input_o\ & (\SW[4]~input_o\ & \SW[2]~input_o\))))
...
-- Equation(s):
-- \ALU4|Mult0|auto_generated|le3a\(1) = (\SW[0]~input_o\ & (\SW[5]~input_o\ $ (((\SW[1]~input_o\))))) # (!\SW[0]~input_o\ & (((!\SW[4]~input_o\ & \SW[1]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	datab => \ALU4|Mult0|auto_generated|le3a\(1),
	datad => VCC,
...
\ALU4|m[3]~8\ : cycloneive_lcell_comb
-- Equation(s):
-- \ALU4|m[3]~8_combout\ = (\SW[9]~input_o\ & (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & \ALU4|Mult0|auto_generated|op_3~14_combout\)))
...
PORT MAP (
	...
	datab => \SW[10]~input_o\,
	datac => \SW[8]~input_o\,
	datad => \ALU4|Mult0|auto_generated|op_3~14_combout\,
	combout => \ALU4|m[3]~8_combout\);

-- Location: LCCOMB_X112_Y14_N14
\ALU4|m[2]~9\ : cycloneive_lcell_comb
-- Equation(s):
-- \ALU4|m[2]~9_combout\ = (\SW[9]~input_o\ & (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & \ALU4|Mult0|auto_generated|op_3~12_combout\)))
...
PORT MAP (
	...
	datab => \SW[10]~input_o\,
	datac => \SW[8]~input_o\,
	datad => \ALU4|Mult0|auto_generated|op_3~12_combout\,
	combout => \ALU4|m[2]~9_combout\);

-- Location: LCCOMB_X112_Y14_N0
\ALU4|m[1]~10\ : cycloneive_lcell_comb
-- Equation(s):
-- \ALU4|m[1]~10_combout\ = (\ALU4|Mult0|auto_generated|op_3~10_combout\ & (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & \SW[9]~input_o\)))
...
PORT MAP (
	...
	datac => \SW[8]~input_o\,
	datad => \SW[9]~input_o\,
	combout => \ALU4|m[1]~10_combout\);

-- Location: LCCOMB_X112_Y14_N26
\ALU4|m[0]~11\ : cycloneive_lcell_comb
-- Equation(s):
-- \ALU4|m[0]~11_combout\ = (\ALU4|Mult0|auto_generated|op_3~8_combout\ & (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & \SW[9]~input_o\)))
...
PORT MAP (
	...
	datac => \SW[8]~input_o\,
	datad => \SW[9]~input_o\,
	combout => \ALU4|m[0]~11_combout\);

-- Location: LCCOMB_X113_Y15_N0
\ALU4|Mod0|auto_generated|divider|divider|StageOut[5]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|StageOut[5]~0_combout\ = (\SW[0]~input_o\ & (!\SW[6]~input_o\ & \SW[1]~input_o\)) # (!\SW[0]~input_o\ & ((!\SW[1]~input_o\)))
...
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ = (\SW[7]~input_o\ & ((\SW[3]~input_o\) # ((\SW[2]~input_o\) # (\ALU4|Mod0|auto_generated|divider|divider|StageOut[5]~0_combout\))))
...
PORT MAP (
	...
	datab => \SW[7]~input_o\,
	datac => \SW[2]~input_o\,
	datad => \ALU4|Mod0|auto_generated|divider|divider|StageOut[5]~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Mod0|auto_generated|divider|divider|selnose[5]~0_combout\,
	datab => \SW[0]~input_o\,
	datac => \SW[6]~input_o\,
...
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~0_combout\ = (\SW[5]~input_o\ & ((GND) # (!\SW[0]~input_o\))) # (!\SW[5]~input_o\ & (\SW[0]~input_o\ $ (GND)))
...
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~2_combout\ = (\SW[1]~input_o\ & ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & (!\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)) # 
-- (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & ((\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (GND))))) # (!\SW[1]~input_o\ & ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & 
-- (\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\ & VCC)) # (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & (!\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\))))
-- \ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\ = CARRY((\SW[1]~input_o\ & ((!\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\))) # 
-- (!\SW[1]~input_o\ & (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & !\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)))
...
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[2]~4_combout\ = ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ $ (\SW[2]~input_o\ $ (\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\)))) # (GND)
-- \ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[2]~5\ = CARRY((\ALU4|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ & ((!\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\) # (!\SW[2]~input_o\))) # 
-- (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ & (!\SW[2]~input_o\ & !\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\)))
...
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|StageOut[10]~3_combout\ = (\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & (\ALU4|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\)) # 
-- (!\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & ((\SW[3]~input_o\ & (\ALU4|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\)) # (!\SW[3]~input_o\ & 
...
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|StageOut[9]~4_combout\ = (\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & (((\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\)))) # 
-- (!\ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & ((\SW[3]~input_o\ & ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\))) # (!\SW[3]~input_o\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~2_combout\,
	datab => \ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\,
	datac => \ALU4|Mod0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\,
	datad => \SW[3]~input_o\,
...
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~2_combout\ = (\SW[1]~input_o\ & ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[8]~5_combout\ & (!\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\)) # 
-- (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[8]~5_combout\ & ((\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\) # (GND))))) # (!\SW[1]~input_o\ & ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[8]~5_combout\ & 
-- (\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\ & VCC)) # (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[8]~5_combout\ & (!\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\))))
-- \ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\ = CARRY((\SW[1]~input_o\ & ((!\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\) # (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[8]~5_combout\))) # 
-- (!\SW[1]~input_o\ & (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[8]~5_combout\ & !\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\)))
...
PORT MAP (
	dataa => \SW[1]~input_o\,
	datab => \ALU4|Mod0|auto_generated|divider|divider|StageOut[8]~5_combout\,
	datad => VCC,
...
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~4_combout\ = ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[9]~4_combout\ $ (\SW[2]~input_o\ $ (\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\)))) # (GND)
-- \ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\ = CARRY((\ALU4|Mod0|auto_generated|divider|divider|StageOut[9]~4_combout\ & ((!\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\) # (!\SW[2]~input_o\))) # 
-- (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[9]~4_combout\ & (!\SW[2]~input_o\ & !\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Mod0|auto_generated|divider|divider|StageOut[9]~4_combout\,
	datab => \SW[2]~input_o\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[3]~6_combout\,
	datac => \ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\,
	datad => \ALU4|Mod0|auto_generated|divider|divider|StageOut[10]~3_combout\,
	combout => \ALU4|Mod0|auto_generated|divider|divider|StageOut[15]~6_combout\);

-- Location: LCCOMB_X111_Y14_N20
\ALU4|Mux0~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \ALU4|Mux0~4_combout\ = (\SW[3]~input_o\ & ((\SW[9]~input_o\ $ (\SW[7]~input_o\)) # (!\SW[8]~input_o\))) # (!\SW[3]~input_o\ & ((\SW[9]~input_o\ & ((\SW[7]~input_o\))) # (!\SW[9]~input_o\ & (!\SW[8]~input_o\))))
...
PORT MAP (
	...
	datac => \SW[3]~input_o\,
	datad => \SW[7]~input_o\,
	combout => \ALU4|Mux0~4_combout\);

-- Location: LCCOMB_X111_Y14_N6
\ALU4|Mux0~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \ALU4|Mux0~5_combout\ = (\ALU4|Mux0~4_combout\ & ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[15]~6_combout\) # ((\SW[9]~input_o\) # (\SW[8]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Mod0|auto_generated|divider|divider|StageOut[15]~6_combout\,
	datab => \ALU4|Mux0~4_combout\,
	datac => \SW[9]~input_o\,
	datad => \SW[8]~input_o\,
	combout => \ALU4|Mux0~5_combout\);

-- Location: LCCOMB_X112_Y14_N18
\ALU4|Mux0~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \ALU4|Mux0~1_combout\ = (\SW[10]~input_o\) # ((\SW[8]~input_o\ & \SW[9]~input_o\))
...
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|selnose[0]~1_combout\ = (!\SW[3]~input_o\ & !\SW[2]~input_o\)
...
PORT MAP (
	dataa => \SW[1]~input_o\,
	datab => \SW[7]~input_o\,
	datac => \ALU4|Mod0|auto_generated|divider|divider|selnose[0]~1_combout\,
	datad => \SW[0]~input_o\,
...
-- Equation(s):
-- \ALU4|Add0~0_combout\ = \SW[3]~input_o\ $ (\SW[8]~input_o\)
...
-- Equation(s):
-- \ALU4|Add0~2_combout\ = \SW[8]~input_o\ $ (\SW[1]~input_o\)
...
-- Equation(s):
-- \ALU4|Add0~6_combout\ = (\SW[4]~input_o\ & ((\ALU4|Add0~3_combout\ & (\ALU4|Add0~5_cout\ & VCC)) # (!\ALU4|Add0~3_combout\ & (!\ALU4|Add0~5_cout\)))) # (!\SW[4]~input_o\ & ((\ALU4|Add0~3_combout\ & (!\ALU4|Add0~5_cout\)) # (!\ALU4|Add0~3_combout\ & 
-- ((\ALU4|Add0~5_cout\) # (GND)))))
-- \ALU4|Add0~7\ = CARRY((\SW[4]~input_o\ & (!\ALU4|Add0~3_combout\ & !\ALU4|Add0~5_cout\)) # (!\SW[4]~input_o\ & ((!\ALU4|Add0~5_cout\) # (!\ALU4|Add0~3_combout\))))
...
-- Equation(s):
-- \ALU4|Add0~8_combout\ = ((\ALU4|Add0~2_combout\ $ (\SW[5]~input_o\ $ (!\ALU4|Add0~7\)))) # (GND)
-- \ALU4|Add0~9\ = CARRY((\ALU4|Add0~2_combout\ & ((\SW[5]~input_o\) # (!\ALU4|Add0~7\))) # (!\ALU4|Add0~2_combout\ & (\SW[5]~input_o\ & !\ALU4|Add0~7\)))
...
-- Equation(s):
-- \ALU4|Add0~10_combout\ = (\ALU4|Add0~1_combout\ & ((\SW[6]~input_o\ & (\ALU4|Add0~9\ & VCC)) # (!\SW[6]~input_o\ & (!\ALU4|Add0~9\)))) # (!\ALU4|Add0~1_combout\ & ((\SW[6]~input_o\ & (!\ALU4|Add0~9\)) # (!\SW[6]~input_o\ & ((\ALU4|Add0~9\) # (GND)))))
-- \ALU4|Add0~11\ = CARRY((\ALU4|Add0~1_combout\ & (!\SW[6]~input_o\ & !\ALU4|Add0~9\)) # (!\ALU4|Add0~1_combout\ & ((!\ALU4|Add0~9\) # (!\SW[6]~input_o\))))
...
-- Equation(s):
-- \ALU4|Mux0~0_combout\ = (!\SW[10]~input_o\ & \SW[9]~input_o\)
...
-- Equation(s):
-- \ALU4|Mux0~2_combout\ = (\ALU4|Mux0~0_combout\ & (((\ALU4|Mult0|auto_generated|op_3~6_combout\) # (\ALU4|Mux0~1_combout\)))) # (!\ALU4|Mux0~0_combout\ & (\ALU4|Add0~12_combout\ & ((!\ALU4|Mux0~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Add0~12_combout\,
	datab => \ALU4|Mux0~0_combout\,
...
-- Equation(s):
-- \ALU4|Mux0~3_combout\ = (\ALU4|Mux0~1_combout\ & ((\ALU4|Mux0~2_combout\ & ((!\ALU4|Mod0|auto_generated|divider|divider|selnose\(0)))) # (!\ALU4|Mux0~2_combout\ & (\ALU4|Mux0~5_combout\)))) # (!\ALU4|Mux0~1_combout\ & (((\ALU4|Mux0~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Mux0~5_combout\,
	datab => \ALU4|Mux0~1_combout\,
	datac => \ALU4|Mod0|auto_generated|divider|divider|selnose\(0),
	datad => \ALU4|Mux0~2_combout\,
	combout => \ALU4|Mux0~3_combout\);

-- Location: LCCOMB_X112_Y14_N12
\ALU4|Mux1~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \ALU4|Mux1~2_combout\ = (\SW[6]~input_o\ & ((\SW[2]~input_o\ $ (\SW[9]~input_o\)) # (!\SW[8]~input_o\))) # (!\SW[6]~input_o\ & ((\SW[9]~input_o\ & (\SW[2]~input_o\)) # (!\SW[9]~input_o\ & ((!\SW[8]~input_o\)))))
...
PORT MAP (
	...
	datac => \ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\,
	datad => \ALU4|Mod0|auto_generated|divider|divider|StageOut[9]~4_combout\,
...
-- Equation(s):
-- \ALU4|Mux1~3_combout\ = (\ALU4|Mux1~2_combout\ & ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[14]~7_combout\) # ((\SW[8]~input_o\) # (\SW[9]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Mux1~2_combout\,
	datab => \ALU4|Mod0|auto_generated|divider|divider|StageOut[14]~7_combout\,
	datac => \SW[8]~input_o\,
	datad => \SW[9]~input_o\,
...
-- Equation(s):
-- \ALU4|Mux1~0_combout\ = (\ALU4|Mux0~0_combout\ & (((\ALU4|Mux0~1_combout\)))) # (!\ALU4|Mux0~0_combout\ & ((\ALU4|Mux0~1_combout\ & (\ALU4|Mux1~3_combout\)) # (!\ALU4|Mux0~1_combout\ & ((\ALU4|Add0~10_combout\)))))
...
-- Equation(s):
-- \ALU4|Mod0|auto_generated|divider|divider|selnose[5]~2_combout\ = (\ALU4|Mod0|auto_generated|divider|divider|selnose[5]~0_combout\) # ((!\SW[6]~input_o\ & \SW[0]~input_o\))
...
PORT MAP (
	dataa => \SW[6]~input_o\,
	datac => \ALU4|Mod0|auto_generated|divider|divider|selnose[5]~0_combout\,
	datad => \SW[0]~input_o\,
...
-- Equation(s):
-- \ALU4|Mux1~1_combout\ = (\ALU4|Mux1~0_combout\ & (((!\ALU4|Mod0|auto_generated|divider|divider|selnose[5]~2_combout\)) # (!\ALU4|Mux0~0_combout\))) # (!\ALU4|Mux1~0_combout\ & (\ALU4|Mux0~0_combout\ & (\ALU4|Mult0|auto_generated|op_3~4_combout\)))
...
PORT MAP (
	...
	datad => \ALU4|Mod0|auto_generated|divider|divider|selnose[5]~2_combout\,
...
-- Equation(s):
-- \ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~2_combout\ = (\SW[1]~input_o\ & ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & (!\ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)) # 
-- (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & ((\ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (GND))))) # (!\SW[1]~input_o\ & ((\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & 
-- (\ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\ & VCC)) # (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & (!\ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\))))
-- \ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\ = CARRY((\SW[1]~input_o\ & ((!\ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\))) # 
-- (!\SW[1]~input_o\ & (!\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & !\ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)))
...
-- pragma translate_on
PORT MAP (
	datab => \ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\,
	datac => \ALU4|Mod0|auto_generated|divider|divider|StageOut[8]~5_combout\,
...
-- Equation(s):
-- \ALU4|Mux2~2_combout\ = (\SW[5]~input_o\ & ((\SW[9]~input_o\ $ (\SW[1]~input_o\)) # (!\SW[8]~input_o\))) # (!\SW[5]~input_o\ & ((\SW[9]~input_o\ & ((\SW[1]~input_o\))) # (!\SW[9]~input_o\ & (!\SW[8]~input_o\))))
...
-- Equation(s):
-- \ALU4|Mux2~0_combout\ = (\ALU4|Mux0~1_combout\ & (((\ALU4|Mux0~0_combout\)))) # (!\ALU4|Mux0~1_combout\ & ((\ALU4|Mux0~0_combout\ & ((\ALU4|Mult0|auto_generated|op_3~2_combout\))) # (!\ALU4|Mux0~0_combout\ & (\ALU4|Add0~8_combout\))))
...
-- Equation(s):
-- \ALU4|Mux2~1_combout\ = (\ALU4|Mux2~0_combout\ & (((!\ALU4|Mux0~1_combout\)) # (!\ALU4|Div0|auto_generated|divider|divider|selnose\(10)))) # (!\ALU4|Mux2~0_combout\ & (((\ALU4|Mux2~3_combout\ & \ALU4|Mux0~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Div0|auto_generated|divider|divider|selnose\(10),
...
-- Equation(s):
-- \ALU4|Mux3~0_combout\ = (\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\ & (\SW[4]~input_o\)) # (!\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\ & ((\SW[8]~input_o\ & (\SW[4]~input_o\)) # 
-- (!\SW[8]~input_o\ & ((\ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~0_combout\)))))
...
PORT MAP (
	...
	datab => \ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\,
	datac => \SW[8]~input_o\,
	datad => \ALU4|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~0_combout\,
...
-- Equation(s):
-- \ALU4|Mux3~2_combout\ = (\SW[9]~input_o\ & ((\SW[0]~input_o\ & ((!\SW[4]~input_o\) # (!\ALU4|Mux3~1_combout\))) # (!\SW[0]~input_o\ & ((\SW[4]~input_o\))))) # (!\SW[9]~input_o\ & (((\ALU4|Mux3~1_combout\))))
...
-- Equation(s):
-- \ALU4|Mux3~3_combout\ = (\ALU4|Mux0~0_combout\ & (((\ALU4|Mux0~1_combout\)))) # (!\ALU4|Mux0~0_combout\ & ((\ALU4|Mux0~1_combout\ & ((\ALU4|Mux3~2_combout\))) # (!\ALU4|Mux0~1_combout\ & (\ALU4|Add0~6_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Add0~6_combout\,
	datab => \ALU4|Mux0~0_combout\,
	datac => \ALU4|Mux3~2_combout\,
	datad => \ALU4|Mux0~1_combout\,
...
PORT MAP (
	...
	datac => \ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[2]~4_combout\,
	datad => \ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\,
...
-- Equation(s):
-- \ALU4|Div0|auto_generated|divider|divider|StageOut[9]~1_combout\ = (\SW[3]~input_o\ & (\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\)) # (!\SW[3]~input_o\ & ((\ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ 
-- & (\ALU4|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\)) # (!\ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & ((\ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~2_combout\)))))
...
PORT MAP (
	...
	datac => \ALU4|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~0_combout\,
	datad => \SW[3]~input_o\,
...
-- Equation(s):
-- \ALU4|Mux3~4_combout\ = (\ALU4|Mux3~3_combout\ & (((!\ALU4|Mux0~0_combout\) # (!\ALU4|Div0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\)))) # (!\ALU4|Mux3~3_combout\ & (\ALU4|Mult0|auto_generated|op_3~0_combout\ & 
-- ((\ALU4|Mux0~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \ALU4|Mult0|auto_generated|op_3~0_combout\,
	datab => \ALU4|Mux3~3_combout\,
	datac => \ALU4|Div0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\,
