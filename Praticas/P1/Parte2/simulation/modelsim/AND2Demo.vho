...
SIGNAL \and2_1|outPort~combout\ : std_logic;
SIGNAL \and2_1|ALT_INV_outPort~combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\and2_1|ALT_INV_outPort~combout\ <= NOT \and2_1|outPort~combout\;
...
-- pragma translate_on
PORT MAP (
	i => \and2_1|ALT_INV_outPort~combout\,
	devoe => ww_devoe,
	o => \LEDG[0]~output_o\);
...
\and2_1|outPort\ : cycloneive_lcell_comb
-- Equation(s):
-- \and2_1|outPort~combout\ = (\SW[1]~input_o\ & \SW[0]~input_o\)
...
PORT MAP (
	dataa => \SW[1]~input_o\,
	datad => \SW[0]~input_o\,
	combout => \and2_1|outPort~combout\);
